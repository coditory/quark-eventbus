    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                description.set("Coditory Quark - event bus library")
                url.set("https://github.com/coditory/quark-eventbus")
                organization {
                    name.set("Coditory")
                ...
                scm {
                    connection.set("scm:git@github.com:coditory/quark-eventbus.git")
                    developerConnection.set("scm:git@github.com:coditory/quark-eventbus.git")
                    url.set("https://github.com/coditory/quark-eventbus")
                }
                issueManagement {
                    system.set("GitHub")
                    url.set("https://github.com/coditory/quark-eventbus/issues")
                }
            }
        }
    }
